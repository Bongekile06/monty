...
#include <ctype.h>
/**
 * struct stack_s - Represents a doubly linked list node in a stack (or queue).
 ...
 * for use in the Stack, Queues, LIFO, FIFO Holberton project.
 */
...
/**
 * struct bus_s - Structure for carrying program values.
 * @arg: Value
 * @file: Pointer to Monty file
 * @content: Line content
 * @lifi: Flag for changing between stack and queue mode
 *
 * Description: This structure is used to transport values throughout the program.
 */
 ...
 * for the Stack, Queues, LIFO, FIFO Holberton project.
 */
